...
export class Controller {
  ...
  async loadText(text) {
    return this.textLoader.createText('./modules/RuneScape_UF_Regular.json', '0xffffff', text)
  }
  ...
  async _createExampleWorld() {
    ...
    const wall = new Wall(this, 'wall', 1, new THREE.Vector3(0, 0, 8), new THREE.Vector3(3, 3, 3))
  }
