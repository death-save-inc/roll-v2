...
export class LeveledSpiralCurve extends THREE.Curve {
  ...
  getPoint(t) {
    ...
    const r = THREE.MathUtils.lerp(this.parent.RADIUS_BOTTOM, this.parent.CENTER_RADIUS, s)
...
export class MagicSwirles {
  constructor(controller) {
    ...
    controller.registerRenderAction('lightnigSwirles', 5, () => this._update())
  }
  ...
  _buildVFX() {
    this.pointlight = new THREE.PointLight(0xffffff, 0, 0, 0.5)
